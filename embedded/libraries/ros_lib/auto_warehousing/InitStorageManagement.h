#ifndef _ROS_SERVICE_InitStorageManagement_h
#define _ROS_SERVICE_InitStorageManagement_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char INITSTORAGEMANAGEMENT[] = "auto_warehousing/InitStorageManagement";

  class InitStorageManagementRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return INITSTORAGEMANAGEMENT; };
    const char * getMD5(){ return "5a55cac834b00525e8b72ae394675bd1"; };

  };

  class InitStorageManagementResponse : public ros::Msg
  {
    public:
      typedef bool _success_type;
      _success_type success;

    InitStorageManagementResponse():
      success(0)
    {
    }
