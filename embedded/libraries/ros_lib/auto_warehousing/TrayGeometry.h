#ifndef _ROS_auto_warehousing_TrayGeometry_h
#define _ROS_auto_warehousing_TrayGeometry_h
...
namespace auto_warehousing
{
  ...
  class TrayGeometry : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "auto_warehousing/TrayGeometry"; };
