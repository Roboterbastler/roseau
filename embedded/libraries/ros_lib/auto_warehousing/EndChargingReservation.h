#ifndef _ROS_SERVICE_EndChargingReservation_h
#define _ROS_SERVICE_EndChargingReservation_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char ENDCHARGINGRESERVATION[] = "auto_warehousing/EndChargingReservation";

  class EndChargingReservationRequest : public ros::Msg
  {
    public:
      typedef uint32_t _charging_station_id_type;
      _charging_station_id_type charging_station_id;

    EndChargingReservationRequest():
    ...
    const char * getType(){ return ENDCHARGINGRESERVATION; };
    const char * getMD5(){ return "41410a323e12d14320b3b9a0be7226b3"; };

  };

  class EndChargingReservationResponse : public ros::Msg
  {
    public:
      typedef bool _success_type;
      _success_type success;

    EndChargingReservationResponse():
      success(0)
    {
    }
  ...
  class EndChargingReservation {
    public:
    typedef EndChargingReservationRequest Request;
    typedef EndChargingReservationResponse Response;
  };
