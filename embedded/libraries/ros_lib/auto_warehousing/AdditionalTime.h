#ifndef _ROS_auto_warehousing_AdditionalTime_h
#define _ROS_auto_warehousing_AdditionalTime_h
...
namespace auto_warehousing
{
  ...
  class AdditionalTime : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "auto_warehousing/AdditionalTime"; };
    const char * getMD5(){ return "595a4e99326479146b97bd6237a70ce2"; };
